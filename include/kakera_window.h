...
extern KAKERA_EXPORT void               kakera_RegisterScene(kakera_Window* window, const char* name, kakera_Scene* scene);
...
extern KAKERA_EXPORT void               kakera_SetWindowIcon(kakera_Window* window);
